...
(* OASIS_START *)
(* DO NOT EDIT (digest: 386a4a32a4be3d8ebac4a0a09816d4fe) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Paul Barbenne"];
          homepage = None;
          synopsis = "A lisp-looking script language";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\253\134$T\245\163l\180\t\187\228\245\031\250\160&";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
